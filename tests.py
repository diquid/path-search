...
class MyTestCase(unittest.TestCase):
    def test_undirected_graph(self):
        g = GraphSearchAlgorithms(vertex_count=6,
                                  edges=[(0, 1),
                                         (1, 2),
                                         (2, 3),
                                         (3, 4),
    ...
    def test_dijkstra_not_work_with_negative_weight(self):
        g = WeightedGraphSearchAlgorithms(vertex_count=3,
                                          edges=[(0, 2, -2),
                                                 (0, 1, -1),
                                                 (2, 1, 1)],
                                          oriented=True)
    ...
    def test_floyd_work_with_negative_weight(self):
        g = WeightedGraphSearchAlgorithms(vertex_count=4,
                                          edges=[(0, 1, -10),
                                                 (0, 2, 9),
                                                 (2, 3, -1)],
                                          oriented=True)
    ...
    def test_weighted_graph_search_algorithms(self):
        g1 = WeightedGraphSearchAlgorithms(vertex_count=3,
                                           edges=[(0, 2, 1),
                                                  (0, 1, 5),
                                                  (2, 1, 1)],
                                           oriented=True)
        ...
        g2 = WeightedGraphSearchAlgorithms(vertex_count=3,
                                           edges=[(0, 1, 1000),
                                                  (1, 0, 5),
                                                  (1, 2, 1)],
                                           oriented=False)
        ...
        g3 = WeightedGraphSearchAlgorithms(vertex_count=3,
                                           edges=[(0, 1, 1000),
                                                  (1, 0, 5),
                                                  (1, 2, 1)],
                                           oriented=True)
    ...
    def test_tree_builder(self):
        for i in range(1, 100):
            graphs = [graph_random_builder.get_tree_without_negative_edges(
                          i * 2, False),
                      graph_random_builder.get_tree_without_negative_edges(
                          i * 2, True),
                      graph_random_builder.get_tree_with_negative_edges(
                          i * 2)]
            for j in graphs:
